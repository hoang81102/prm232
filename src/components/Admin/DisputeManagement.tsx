...
const DisputeManagement = () => {
  const [disputes, setDisputes] = useState<DisputeSchema[]>([]);
  const [selectedDispute, setSelectedDispute] = useState<DisputeSchema | null>(
    null
  );
  ...
  const handleCloseDispute = async () => {
    if (
      selectedDispute &&
      window.confirm("Bạn có chắc muốn đánh dấu tranh chấp này đã giải quyết?")
    ) {
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-muted-foreground">
              Quản lý và xử lý các vấn đề phát sinh
            </p>
          </div>
        </div>
                ...
                disputes.map((d) => (
                  ...
                  >
                    ...
                    <div className="flex items-center text-xs text-gray-500 gap-2 mt-2">
                      ...
                      <span>
                        {dayjs(d.createdAt).format("DD-MM-YYYY") || "N/A"}
                      </span>
                ...
                <div className="p-4 border-b flex justify-between items-center bg-gray-50">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      ID: #{selectedDispute.disputeId} • Tạo bởi User #
